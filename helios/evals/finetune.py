...
# from olmo_core.train.checkpointer import Checkpointer
...
#     def __init__(self, encoder, task_type: TaskType, num_classes: int) -> None:
...
# def finetune_cls():
#     """Finetune the Helios model on a downstream task."""
#     path = Path("/weka/dfive-default/helios/checkpoints/henryh/3latentmim_tiny_masking_random_loss_patch_discrimination_new_token_exit_zero")
#     # build the train_module
#     latentmim_config = LatentMIMTrainModuleConfig(
