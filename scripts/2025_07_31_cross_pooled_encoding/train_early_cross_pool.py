...
def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    ...
    encoder_config = EncoderEarlyAttnPoolConfig(
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    EVAL_TASKS = {
        "m_eurosat_pooled": DownstreamTaskConfig(
            ...
            use_pooled_tokens=True,
            norm_stats_from_pretrained=True,
            eval_interval=Duration.steps(4000),
        ),
        "pastis_sentinel2_pooled": DownstreamTaskConfig(
            dataset="pastis",
        ...
        "pastis_sentinel1_sentinel2_pooled": DownstreamTaskConfig(
            dataset="pastis",
            embedding_batch_size=32,
            probe_batch_size=8,
            num_workers=8,
        ...
        "mados_pooled": DownstreamTaskConfig(
            dataset="mados",
            embedding_batch_size=128,
        ...
        "m_cashew_plant_pooled": DownstreamTaskConfig(
