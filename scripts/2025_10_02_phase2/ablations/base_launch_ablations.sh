...
python scripts/2025_10_02_phase2/ablations/base_random_masking.py launch phase2.0_base_random_s1s2landsat_random_patchdisc_nocon_emafull ai2/jupiter --train_module.contrastive_config.loss_config.weight=0.0 --train_module.loss_config.loss_config.type=patch_discrimination_new --common.training_modalities='[sentinel2_l2a,sentinel1,landsat]' --train_module.ema_decay='[0.996,1.0]' --launch.priority=urgent --trainer.callbacks.wandb.project=2025_10_08_phase2_ablations
# modalities: s1, s2, landsat. loss: patchdisc. Contrastive: no. EMA: no, 0 exit depth, random masking
python scripts/2025_10_02_phase2/ablations/base_random_masking.py launch phase2.0_base_random_s1s2landsat_random_patchdisc_nocon_emafull ai2/jupiter --train_module.contrastive_config.loss_config.weight=0.0 --train_module.loss_config.loss_config.type=patch_discrimination_new --common.training_modalities='[sentinel2_l2a,sentinel1,landsat]' --launch.priority=urgent --trainer.callbacks.wandb.project=2025_10_08_phase2_ablations
# modalities: s1, s2, landsat. loss: patchdisc. Contrastive: no. EMA: no, 0 exit depth, cross_mod_rand masking
python scripts/2025_10_02_phase2/base.py launch phase2.0_base_random_s1s2landsat_random_patchdisc_nocon_emafull ai2/jupiter --train_module.contrastive_config.loss_config.weight=0.0 --train_module.loss_config.loss_config.type=patch_discrimination_new --common.training_modalities='[sentinel2_l2a,sentinel1,landsat]' --launch.priority=urgent --trainer.callbacks.wandb.project=2025_10_08_phase2_ablations
